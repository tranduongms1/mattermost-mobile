            ...
            >
                ...
                >
                    ...
                    <Tab.Screen
                        ...
                        component={Contacts}
                        options={{tabBarTestID: 'tab_bar.contacts.tab', unmountOnBlur: false, freezeOnBlur: true, lazy: true}}
                    />
                    <Tab.Screen
                        name={Screens.NEWS}
                        component={News}
                        options={{tabBarTestID: 'tab_bar.news.tab', freezeOnBlur: true, lazy: true}}
                    />
                    <Tab.Screen
                        name={Screens.SEARCH}
                        component={Search}
